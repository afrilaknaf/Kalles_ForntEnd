            ...
            <div className="w-full  h-auto p-4 flex flex-wrap justify-center items-center gap-5">
                {
                    watches.map((item, index) => {
                        ...
                        const normal_wish = normal?.some((wish) => {
                        ...
                        return (
                            <div data-aos="fade-up"
                                ...
                                }} className="w-9 h-9 text-xl block lg:hidden rounded-full border absolute top-50 end-0 mr-5"><i class="ri-eye-line"></i></button>
                                <button onClick={() => {
                                    handlecart(item)
                                }} className="w-9 h-9 text-xl block lg:hidden bg-[#C91F28] text-white rounded-full border absolute top-60 mt-3 end-0 mr-5"><i class="ri-shopping-cart-2-line"></i></button>
